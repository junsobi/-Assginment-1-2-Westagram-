  ...
  return (
    <div className="articleComment">
      <div className="details">
        <span className="who">Wecode_bootcamp</span> "위코드는 단순 교육업체가
        아닌 개발자 커뮤니티입니다. Wecode에서 배우고 저는 총 5개회사에서 오퍼를
        받았습니다" <br />
    ...
    <div className="story">
      ...
      <div className="storyMembers">
        ...
        <div className="second S LineStory">
          <img className="storyPeo" alt="두번째" src="images/peoples3.webp" />
        ...
        <div className="third S LineStory">
          <img className="storyPeo" alt="세번째" src="images/peoples4.webp" />
        ...
        <div className="fourth S LineStory">
          <img className="storyPeo" alt="네번째" src="images/peoples5.webp" />
    ...
    <div className="recomend">
      ...
      <div className="recomendWho">
        ...
        <div className="second LineRecomend">
          <div className="recomendPC">
            <img className="storyPeo" alt="두번째" src="images/peoples7.webp" />
            <div className="second LineDetails">
        ...
        <div className="second R LineRecomend">
          <div className="recomendPC">
            <img className="storyPeo" alt="두번째" src="images/peoples8.webp" />
            <div className="second LineDetails">
